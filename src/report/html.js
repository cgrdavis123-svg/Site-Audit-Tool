...
.brand-eyebrow { display: flex; align-items: center; gap: 8px; margin-bottom: 6px; }
.brand-eyebrow img { width: 20px; height: 20px; border-radius: 5px; }
.brand-eyebrow span { font-size: 11px; font-weight: 700; letter-spacing: .06em; text-transform: uppercase; color: var(--text-dim); }
...
<title>Syndicate Marketing Site Audit — ${esc(meta.startUrl)}</title>
<link rel="icon" href="/icons/favicon-32.png" sizes="32x32">
<link rel="icon" href="/icons/favicon-256.png" sizes="256x256">
<style>${STYLE}</style>
</head>
<body>
<div class="wrap">
  <div class="header">
    <div>
      <div class="brand-eyebrow"><img src="/icons/favicon-256.png" alt=""><span>Syndicate Marketing</span></div>
  ...
  <footer>Generated by Syndicate Marketing Site Audit &middot; &copy; 2026 Syndicate Holdings Group LLC${accessibility && !accessibility.available ? ' — accessibility checks skipped' : ''}</footer>
</div>
